...
// ─────────────────────────────────────────────
// KAPITEL 2: Seitensteuerung & UI-Wechsel (mit Fade)
// ─────────────────────────────────────────────

// ─────────────────────────────────────────────
// KAPITEL 2: Seitensteuerung & UI-Wechsel (Fade-In/Fade-Out)
// ─────────────────────────────────────────────
...
function showPage(id) {
  ...
  // Aktive Seite finden und ausblenden
  const current = document.querySelector(".page.active");
  if (current) {
    current.classList.remove("active");
    current.style.opacity = "0";

    // Nach 0.5s: Seite verstecken
    setTimeout(() => {
      ...
      // Warten auf nächsten Frame, dann Fade-In
